...
package com.rich.tutorial.blog.controller;
...
import com.rich.tutorial.blog.dao.BlogPostDAO;
import com.rich.tutorial.blog.dao.SessionDAO;
import com.rich.tutorial.blog.dao.UserDAO;
...
public class BlogController {
    ...
    public BlogController(MongoDatabase blogDatabase) throws IOException {
    ...
    private void initializeRoutes() throws IOException {
        ...
        post(new FreemarkerBasedRoute("/like", "entry_template.ftl") {
            ...
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                ...
                // check return or have checkSession throw
                String username = sessionDAO.findUserNameBySessionId(getSessionCookie(request));
                if (username == null) {
                    // looks like a bad request. user is not logged in
                    response.redirect("/login");
